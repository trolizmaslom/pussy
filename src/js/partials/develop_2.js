function punishScrollPane (){
    /*var hert = $('.conteiner-inside .content-more').height()*3;

    $('.news-lol-scroll').css('height', hert);*/

    $('.news-lol-scroll').jScrollPane({showArrows: false, autoReinitialise:true, contentWidth: '0px', verticalDragMaxHeight:20});
}
